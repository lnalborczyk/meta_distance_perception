...
This model can easily be fitted using the \texttt{brms} package (Bürkner, \protect\hyperlink{ref-R-brms}{2017}), with an lme4-like syntax.
...
We then extract the posterior mean and 95\% credible intervals of the previous model using the \texttt{tidy()} function of the \texttt{broom} package (Robinson, \protect\hyperlink{ref-R-broom}{2017}).
...
We can test the hypothesis that the intercept is equal to 0 by comparing a model with the intercept and a model without the intercept (i.e., with the intercept value fixed to 0). We compare these models using the \texttt{bayes\_factor()} method (that uses the \texttt{bridgesampling} package, Gronau \& Singmann, \protect\hyperlink{ref-R-bridgesampling}{2017}).
...
As different action constraints (e.g., backpack, tool-use) might influence distance perception through different mechanisms, we also computed the effect sizes for each constraint manipulation. We discarded Linkenauger, Bülthoff, and Mohler (\protect\hyperlink{ref-linkenauger_virtual_2015}{2015})'s article (i.e., four studies) from this analysis as their manipulation did not fit in any constraint category.
...
We can plot the posterior distribution corresponding to each \emph{contrast}, using the \texttt{BEST} package (Kruschke \& Meredith, \protect\hyperlink{ref-R-BEST}{2017}). Below, we plot the contrast \texttt{c1}, which represents the comparison of the \texttt{verbal} and \texttt{vm} conditions.
...
Below, we make a contour-enhanced funnel plot, allowing to distinguish patterns of significance in published studies (Peters, Sutton, Jones, Abrams, \& Rushton, \protect\hyperlink{ref-peters2008}{2008}), using the \texttt{metaviz} package (Kossmeier, Tran, \& Voracek, \protect\hyperlink{ref-R-metaviz}{2018}).
...
##  [1] brms_2.10.0          Rcpp_1.0.2           here_0.1            
##  [4] knitr_1.25           readxl_1.3.1         papaja_0.1.0.9709   
...
## [19] bridgesampling_0.7-2
## 
## loaded via a namespace (and not attached):
##  [1] colorspace_1.4-1   ggridges_0.5.1     rsconnect_0.8.15  
##  [4] rprojroot_1.3-2    markdown_1.1       base64enc_0.1-3   
##  [7] rstudioapi_0.10    rstan_2.19.2       DT_0.9            
## [10] lubridate_1.7.4    xml2_1.2.2         extrafont_0.17    
## [13] shinythemes_1.1.2  zeallot_0.1.0      bayesplot_1.7.0   
## [16] jsonlite_1.6       broom_0.5.2        Rttf2pt1_1.3.7    
## [19] shiny_1.4.0        compiler_3.5.3     httr_1.4.1        
## [22] backports_1.1.5    assertthat_0.2.1   Matrix_1.2-17     
## [25] fastmap_1.0.1      lazyeval_0.2.2     cli_1.1.0         
## [28] later_1.0.0        prettyunits_1.0.2  htmltools_0.4.0   
## [31] tools_3.5.3        igraph_1.2.4.1     coda_0.19-3       
## [34] gtable_0.3.0       glue_1.3.1         reshape2_1.4.3    
## [37] cellranger_1.1.0   vctrs_0.2.0        nlme_3.1-141      
## [40] extrafontdb_1.0    crosstalk_1.0.0    xfun_0.10         
## [43] ps_1.3.0           rvest_0.3.4        mime_0.7          
## [46] miniUI_0.1.1.1     lifecycle_0.1.0    gtools_3.8.1      
## [49] zoo_1.8-6          scales_1.0.0       colourpicker_1.0  
## [52] hms_0.5.1          promises_1.1.0     Brobdingnag_1.2-6 
## [55] parallel_3.5.3     inline_0.3.15      shinystan_2.5.0   
## [58] yaml_2.2.0         gridExtra_2.3      StanHeaders_2.19.0
## [61] gdtools_0.2.1      loo_2.1.0.9001     stringi_1.4.3     
## [64] dygraphs_1.1.1.6   pkgbuild_1.0.6     rlang_0.4.0       
## [67] pkgconfig_2.0.3    systemfonts_0.1.1  matrixStats_0.55.0
## [70] evaluate_0.14      lattice_0.20-38    rstantools_2.0.0  
## [73] htmlwidgets_1.5.1  tidyselect_0.2.5   processx_3.4.1    
## [76] plyr_1.8.4         bookdown_0.14      R6_2.4.0          
## [79] generics_0.0.2     pillar_1.4.2       haven_2.1.1       
## [82] withr_2.1.2        xts_0.11-2         abind_1.4-5       
## [85] modelr_0.1.5       crayon_1.3.4       rmarkdown_1.16    
## [88] grid_3.5.3         callr_3.3.2        threejs_0.3.1     
## [91] digest_0.6.21      xtable_1.8-4       httpuv_1.5.2      
## [94] stats4_3.5.3       munsell_0.5.0      shinyjs_1.0
\end{verbatim}
...
\leavevmode\hypertarget{ref-hutchison_does_2006}{}%
Hutchison, J. J., \& Loomis, J. M. (2006). Does Energy Expenditure Affect the Perception of Egocentric Distance? A Failure to Replicate Experiment 1 of Proffitt, Stefanucci, Banton, and Epstein (2003). \emph{The Spanish Journal of Psychology}, \emph{9}(2), 332--339. doi:\href{https://doi.org/10.1017/S1138741600006235}{10.1017/S1138741600006235}

\leavevmode\hypertarget{ref-kirsch_visual_2013}{}%
Kirsch, W., \& Kunde, W. (2013). Visual near space is scaled to parameters of current action plans. \emph{Journal of Experimental Psychology. Human Perception and Performance}, \emph{39}(5), 1313--1325. doi:\href{https://doi.org/10.1037/a0031074}{10.1037/a0031074}
...
\leavevmode\hypertarget{ref-linkenauger_virtual_2015}{}%
Linkenauger, S. A., Bülthoff, H. H., \& Mohler, B. J. (2015). Virtual arm׳s reach influences perceived distances but only after experience reaching. \emph{Neuropsychologia}, \emph{70}, 393--401. doi:\href{https://doi.org/10.1016/j.neuropsychologia.2014.10.034}{10.1016/j.neuropsychologia.2014.10.034}

\leavevmode\hypertarget{ref-meagher_costs_2014}{}%
Meagher, B. R., \& Marsh, K. L. (2014). The costs of cooperation: Action-specific perception in the context of joint action. \emph{Journal of Experimental Psychology. Human Perception and Performance}, \emph{40}(1), 429--444. doi:\href{https://doi.org/10.1037/a0033850}{10.1037/a0033850}
...
\leavevmode\hypertarget{ref-woods_various_2009}{}%
Woods, A. J., Philbeck, J. W., \& Danoff, J. V. (2009). The Various Perceptions of Distance: An Alternative View of How Effort Affects Distance Judgments. \emph{Journal of Experimental Psychology. Human Perception and Performance}, \emph{35}(4), 1104--1117. doi:\href{https://doi.org/10.1037/a0013622}{10.1037/a0013622}
